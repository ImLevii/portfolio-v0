...
export default function About() {
  ...
  return (
    <section id="about" className="section-padding py-24 relative overflow-hidden">
      ...
      <div className="absolute -right-48 top-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full pointer-events-none" aria-hidden="true" style={{ background: 'radial-gradient(ellipse, rgba(239,68,68,0.055) 0%, transparent 65%)' }} />
